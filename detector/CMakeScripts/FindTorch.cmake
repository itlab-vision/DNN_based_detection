...
find_library(TORCH_LIBRARY_LUAJIT luajit PATHS ${TORCH_ROOT_DIR} PATH_SUFFIXES lib)
...
set(TORCH_LIBRARIES ${TORCH_LIBRARY_LUAT} ${TORCH_LIBRARY_LUATH} ${TORCH_LIBRARY} ${TORCH_LIBRARY_NN} ${TORCH_LIBRARY_LUAJIT})
